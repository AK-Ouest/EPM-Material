sap.ui.core.mvc.Controller.extend("EPM-Material.view.Master", {
	...
	handleSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("MaterialDescription", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
